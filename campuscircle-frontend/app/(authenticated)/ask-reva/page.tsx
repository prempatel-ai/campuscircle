...
export default function AskRevaPage() {
  ...
  return (
    <div className="flex-1 text-ink font-sans grid grid-cols-1 lg:grid-cols-12 min-h-[calc(100vh-5rem)]">
      {/* Sidebar */}
      <div className="hidden lg:block lg:col-span-3 xl:col-span-2 border-r border-border-muted bg-surface/50">
        <RevaChatSidebar
      ...
      {/* Chat Area */}
      <div className="lg:col-span-9 xl:col-span-10 max-w-4xl w-full px-4 py-6 flex flex-col mx-auto">
        {!hasStarted ? (
          /* HERO INITIAL STATE */
